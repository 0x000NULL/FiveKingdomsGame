    ...
    public sealed class Importer {
        ...
        private IEnumerator runCoreCommands() {
            ...
            try {
                ...
                failed?.Invoke(sceneConversionException);
    ...
    public struct LodsGenerationSettings {
        ...
        public static LodsGenerationSettings Default()
        {
            return new LodsGenerationSettings(new LodGenerationSettings[] {
                new LodGenerationSettings { threshold = 0.3, quality = LodQuality.MAXIMUM },
                new LodGenerationSettings { threshold = 0.1, quality = LodQuality.LOW },
                new LodGenerationSettings { threshold = 0.0, quality = LodQuality.CULLED } });
        }
