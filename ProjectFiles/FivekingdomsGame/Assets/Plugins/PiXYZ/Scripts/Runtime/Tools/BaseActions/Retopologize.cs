...
namespace PiXYZ.Tools.Builtin
{
    ...
    public class Retopologize : ActionInOut<IList<GameObject>, IList<GameObject>> {
        ...
        public bool bakeTextures = false;

        private bool isBakingMaps() => bakeTextures && isProxy();
            ...
            using (new CoreContext(input.ToArray(), isBakingMaps())) {
                ...
                switch (mode) {
                    case RetopologyMode.ProxyMesh:
                        NativeInterface.Retopologize(isPointCloud, voxelSize * 1000d, bakeTextures, texturesResolution);
                        break;
