    ...
    public class ToolboxWindow : EditorWindow {
        ...
        private IEnumerator Execute() {
            ...
            try {
                ...
                //progressBar.setProgress(0, "Processing...");
                EditorUtility.DisplayProgressBar("PiXYZ", $"Processing...", 0);
                Profiling.Start("ToolboxAction");
                //Toolbox.SetResult(((IList<GameObject>)action.invoke(getSelectedGameObjects()))?.ToArray());
                object result = action.invoke(getSelectedGameObjects());
