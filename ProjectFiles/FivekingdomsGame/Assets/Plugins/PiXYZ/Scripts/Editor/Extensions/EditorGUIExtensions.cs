...
namespace PiXYZ.Editor {
    ...
    public static class EditorGUIExtensions {
        ...
        public static void GUIDrawRect(Rect position, Color color, int borderThickness = 0, string title = "") {
            Color tmp = color;
            tmp.a = 1;
            GUIDrawRect(position, color, tmp, borderThickness, title);
        }

        public static void GUIDrawRect(Rect position, Color color, Color borderColor, int borderThickness = 0, string text = "", TextAnchor rectTextAnchor = TextAnchor.MiddleCenter) {
            ...
            GUI.Box(contentRect, new GUIContent(text), StaticRectStyle);
        }
        ...
        public static void DrawHyperlink(string label, string link, bool bold = false, bool centered = false) {
            ...
            Color linkColor = EditorGUIUtility.isProSkin ? new Color(0.35f, 0.35f, 1) : Color.blue;
